...
public class KindEditorController {
	...
	public Map<String, Object> fileUpload(HttpServletRequest request,
		...
		//	K.addParam(uploadJson, 'dir=image') + "&" + encodeURIComponent($("[name='csrf-param']").attr("content")) + "=" + encodeURIComponent($("[name='csrf-token']").attr("content"))
	...
	@RequestMapping(value = "/editor/fileManager", method = RequestMethod.POST)
